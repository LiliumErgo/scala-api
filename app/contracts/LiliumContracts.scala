...
sealed trait LiliumContracts extends EnumEntry {
  // Top Folder
  val domain: String = ""
  // Sub Folder
...
object LiliumContracts extends Enum[LiliumContracts] {
  val values: immutable.IndexedSeq[LiliumContracts] = findValues
...
sealed trait NFTContract extends LiliumContracts {
  override val domain: String = "Lilium"
}

sealed trait ProxyContract extends LiliumContracts {
  override val domain: String = "Lilium"
}
